...
# `_` is the positional query constraint; the abstract selected source is
# `second`, just as for a description-selected sparse occurrence.
sparse/scarcity/readSecondLastByNegativeIndex, Sparse negative index stays independent of the billion-item prefix, *1000000000+{second| ...}@[-2], second, world, TestFiles/sparseTestCases.pr
