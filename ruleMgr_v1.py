#!/usr/bin/env python3
# Proteus v1 rule case manager.
# Generates only WorldManagerRules_v1.dog for WorldManager_v1.dog.
...
def generateXformMgr(ruleSets):
    generatedHeader = """// AUTOGENERATED BY ruleMgr_v1.py
// DO NOT EDIT
// Used by WorldManager_v1.dog
...
"""
    ...
    structCode += "}"
    with open("WorldManagerRules_v1.dog", "w") as text_file: print(structCode, file=text_file)
